...
export const JOB_ROLES: JobRole[] = [
  ...
  },
  {
    ...
    description: 'Bridges the gap between frontend interfaces and backend data systems, handling end-to-end development.',
    requirements: [
      { skillName: 'JavaScript', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'React', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Node.js', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'SQL', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 },
      { skillName: 'System Design', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 },
      { skillName: 'Git', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 },
  ...
  },
  {
    ...
    description: 'Extracts actionable insights from massive datasets using machine learning, statistics, and domain expertise.',
    requirements: [
      { skillName: 'Python', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'SQL', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'Machine Learning', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'Data Visualization', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 },
      { skillName: 'Statistics', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'Communication', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Problem Solving', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.1 }
    ]
  },
  {
    id: 'mobile',
    title: 'Mobile Developer',
    description: 'Builds seamless, performant applications for iOS and Android platforms.',
    requirements: [
      { skillName: 'React Native / Flutter', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.25 },
      { skillName: 'JavaScript / Dart', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'UI/UX Principles', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'REST APIs', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Problem Solving', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'Git', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 }
    ]
  },
  {
    ...
    description: 'Architects, automates, and maintains scalable cloud infrastructure and deployment pipelines.',
    requirements: [
      { skillName: 'Docker', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'Kubernetes', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'CI/CD', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'AWS / Cloud', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'Linux', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Python / Bash', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 }
    ]
  },
  {
    id: 'product',
    title: 'Product Manager',
    description: 'Drives product strategy, feature prioritization, and cross-functional team alignment.',
    requirements: [
      { skillName: 'Communication', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.3 },
      { skillName: 'Product Strategy', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 },
      { skillName: 'Data Analysis', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Agile/Scrum', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'User Empathy', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.2 }
    ]
  },
  {
    id: 'security',
    title: 'Cyber Security Engineer',
    description: 'Secures applications and infrastructure against vulnerabilities and active threats.',
    requirements: [
      { skillName: 'Network Security', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.25 },
      { skillName: 'Penetration Testing', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.2 },
      { skillName: 'Cryptography', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 },
      { skillName: 'Python', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.1 },
      { skillName: 'Problem Solving', minLevel: SkillLevel.ADVANCED, priority: SkillPriority.CRITICAL, weight: 0.15 },
      { skillName: 'Cloud Security', minLevel: SkillLevel.INTERMEDIATE, priority: SkillPriority.IMPORTANT, weight: 0.15 }
    ]
  }
];
