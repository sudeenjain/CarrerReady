...
export function CareerMentor({ user }: { user: UserProfile }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-8 right-8 w-[90vw] md:w-[420px] h-[650px] max-h-[85vh] bg-[var(--bg-card)] rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] flex flex-col z-[101] overflow-hidden animate-in slide-in-from-bottom-4 border border-[var(--border-color)]">
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar bg-[var(--bg-main)] text-[var(--text-main)] pt-8">
            {messages.map((m, i) => (
          ...
          <div className="p-5 bg-[var(--bg-card)] border-t border-[var(--border-color)]">
            ...
            <p className="text-[9px] text-center text-[var(--text-muted)] font-bold uppercase tracking-widest mt-3">
