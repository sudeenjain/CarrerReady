...
export function ResumeUpload({ onSkillsExtracted, onClose }: ResumeUploadProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/20 dark:bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-[var(--bg-card)] w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-[var(--border-color)]">
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <textarea
              className="w-full h-64 p-4 rounded-2xl border border-[var(--border-color)] bg-slate-50 dark:bg-slate-800 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all resize-none text-sm text-slate-600 dark:text-slate-100 dark:placeholder-slate-500 custom-scrollbar"
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={onClose}
              className="px-8 py-4 bg-slate-50 dark:bg-slate-800 text-[var(--text-muted)] font-bold rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-750 transition-all border border-transparent dark:border-slate-700"
            >
              Cancel
            </button>
          </div>
        ...
        <div className="px-8 py-4 bg-slate-50 dark:bg-slate-800 border-t border-[var(--border-color)] flex items-center justify-between">
